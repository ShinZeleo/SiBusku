...
<?php $component->withAttributes([]); ?>
    <div class="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div 
            ...
            style="background-image: url('<?php echo e(asset('build/assets/Images/Back.png')); ?>');"
        >
            <!-- Black Overlay -->
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full rounded-lg border pl-12 pr-4 py-3.5 text-gray-900 placeholder-gray-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 focus:outline-none transition-all duration-200 text-base <?php $__errorArgs = ['email'];
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full rounded-lg border pl-12 pr-4 py-3.5 text-gray-900 placeholder-gray-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 focus:outline-none transition-all duration-200 text-base <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:border-red-500 focus:ring-red-500/20 <?php unset($message);
...
<?php endif; ?>
            ...
            <p class="text-center text-xs text-white/80 mt-6">
                © <?php echo e(date('Y')); ?> SiBusku. All rights reserved.
            </p>
        </div>
    </div>
 <?php echo $__env->renderComponent(); ?>

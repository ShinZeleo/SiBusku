    ...
    <div class="relative flex flex-col flex-1">
            ...
            <div class="flex items-start justify-between gap-4 mb-4">
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-500 flex items-center gap-1">
                        ...
                        Durasi estimasi <?php echo e($trip->route->duration_estimate); ?> jam
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid gap-3 sm:grid-cols-3 mb-6">
            <div class="rounded-xl bg-gradient-to-br from-gray-50 to-gray-100/50 p-4 border border-gray-100">
                ...
                <p class="font-bold text-gray-900"><?php echo e($trip->departure_date_formatted); ?></p>
            </div>
            <div class="rounded-xl bg-gradient-to-br from-gray-50 to-gray-100/50 p-4 border border-gray-100">
                <div class="flex items-center gap-2 mb-2">
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="font-bold text-gray-900"><?php echo e($trip->departure_time); ?></p>
            </div>
            <div class="rounded-xl bg-gradient-to-br from-gray-50 to-gray-100/50 p-4 border border-gray-100">
                <div class="flex items-center gap-2 mb-2">
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="font-bold text-gray-900 text-sm"><?php echo e($trip->bus->name); ?></p>
                <p class="text-xs text-gray-600"><?php echo e($trip->bus->bus_class); ?></p>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between mb-6 pb-6 border-b border-gray-100 mt-auto">
            <div>
                ...
                <p class="text-3xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">
                    <?php echo e($trip->price_formatted); ?>

                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.buses.update', $bus->id) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $bus->name) }}" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-gray-900 focus:border-sky-500 focus:ring-2 focus:ring-sky-500/40" required>
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="text" name="plate_number" id="plate_number" value="{{ old('plate_number', $bus->plate_number) }}" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-gray-900 focus:border-sky-500 focus:ring-2 focus:ring-sky-500/40" required>
                            @error('plate_number')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <select name="bus_class" id="bus_class" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-gray-900 focus:border-sky-500 focus:ring-2 focus:ring-sky-500/40" required>
                                ...
                                <option value="Eksekutif" {{ old('bus_class', $bus->bus_class) === 'Eksekutif' ? 'selected' : '' }}>Eksekutif</option>
                                <option value="AC" {{ old('bus_class', $bus->bus_class) === 'AC' ? 'selected' : '' }}>AC</option>
                                <option value="Ekonomi" {{ old('bus_class', $bus->bus_class) === 'Ekonomi' ? 'selected' : '' }}>Ekonomi</option>
                            </select>
                            @error('bus_class')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" name="capacity" id="capacity" value="{{ old('capacity', $bus->capacity) }}" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-gray-900 focus:border-sky-500 focus:ring-2 focus:ring-sky-500/40" required min="1">
                            @error('capacity')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>

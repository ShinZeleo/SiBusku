...
<head>
    <meta charset="utf-8">
    <title>E-Ticket SIBUSKU #{{ $booking->id }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="ticket">
        ...
        <div class="booking-code">
            <h2>#{{ str_pad($booking->id, 6, '0', STR_PAD_LEFT) }}</h2>
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        ...
                        {{ \Carbon\Carbon::parse($booking->trip->departure_time)->format('H:i') }} WIB
                    </div>
                </div>
                <div class="info-item">
                    <div class="info-label">Bus</div>
                    <div class="info-value">{{ $booking->trip->bus->name }} ({{ $booking->trip->bus->bus_class }})</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Durasi</div>
                    <div class="info-value">{{ $booking->trip->route->duration_estimate }} jam</div>
                </div>
            </div>
        </div>
        ...
        <div class="seats">
            ...
            <p style="margin-top: 15px; font-size: 12px; color: #6b7280;">
                Total: {{ $booking->seats_count }} kursi × {{ $booking->trip->price_formatted }} =
                <strong style="color: #1e40af;">{{ $booking->total_price_formatted }}</strong>
            </p>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <div class="info-value" style="text-transform: uppercase;">{{ $booking->status }}</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Status Pembayaran</div>
                    <div class="info-value" style="text-transform: uppercase;">{{ $booking->payment_status }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 15px;">Dicetak pada: {{ now()->format('d M Y H:i:s') }}</p>
        </div>
    </div>
</body>
</html>
